// Package branding owns the user-visible SafeLink product identity.
//
...
const (
	ProductName      = "SafeLink"
	ProductUsername  = "safelink"
	DesktopAppName   = "SafeLink Desktop"
	AndroidAppName   = "SafeLink Android"
	IOSAppName       = "SafeLink iOS"
	MacOSAppName     = "SafeLink macOS"
	WebAAppName      = "SafeLink Web"
	WebKAppName      = "SafeLink Web"
	PremiumName      = "SafeLink Premium"
	StarsName        = "SafeLink Stars"
	DefaultPublicURL = "https://safelink.chat"
	AppScheme        = "safelink"
)
...
var (
	officialHTTPHostRE = regexp.MustCompile(`(?i)https?://(?:[a-z0-9-]+\.)*(?:telegram\.(?:org|me|com|dog)|t\.me|telesrv\.net|tidings?\.(?:org|me))([^a-z0-9]|$)`)
	officialBareHostRE = regexp.MustCompile(`(?i)(?:(?:[a-z0-9-]+\.)*telegram\.(?:org|me|com|dog)|\bt\.me|(?:[a-z0-9-]+\.)*telesrv\.net|(?:[a-z0-9-]+\.)*tidings?\.(?:org|me))([^a-z0-9]|$)`)
	officialBrandRE    = regexp.MustCompile(`(?i)telegram|telesrv|tidings?|телеграм[\p{L}]*|تيليجرام|تلگرام|텔레그램|טלגרם`)
