...
func TestImportChatInviteErrorsRPC(t *testing.T) {
	...
	requestHash := strings.TrimPrefix(requestInvite.(*tg.ChatInviteExported).Link, "https://safelink.chat/+")
	...
	limitedHash := strings.TrimPrefix(limitedInvite.(*tg.ChatInviteExported).Link, "https://safelink.chat/+")
