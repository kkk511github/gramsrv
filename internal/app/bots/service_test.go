...
func TestBotFatherNewBotFlow(t *testing.T) {
	...
	if !strings.Contains(reply, "safelink.chat/my_test_bot") {
...
func TestBotFatherUsernameTaken(t *testing.T) {
	...
	if reply := sendToBotFather(t, svc, messages, owner, "second_bot"); !strings.Contains(reply, "safelink.chat/second_bot") {
