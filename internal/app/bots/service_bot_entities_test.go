...
func TestServiceBotReplyEntitiesCommandsAndURLsUseUTF16Offsets(t *testing.T) {
	text := "🙂 Send /cancel or https://safelink.chat/addstickers/fun_pack."
	...
	assertEntity(domain.MessageEntityURL, 19, len("https://safelink.chat/addstickers/fun_pack"))
}

func TestServiceBotReplyEntitiesSkipCommandsInsideURLsAndExplicitEntities(t *testing.T) {
	text := "Token: abc/def\nhttps://safelink.chat/addstickers/fun_pack\nUse /help"
