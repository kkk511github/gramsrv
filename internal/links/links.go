...
// BuildRoot returns the client root used by public home-page open buttons.
func (b AppLinkBuilder) BuildRoot() string {
	if b.baseHost != "" {
		return (&url.URL{Scheme: b.baseScheme, Host: b.baseHost}).String()
	}
	return b.legacyScheme + "://"
}
