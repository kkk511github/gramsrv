...
func TestSendReplaySnapshotMigrationRoundTripPostgres(t *testing.T) {
	...
	downSQL, err := deploy.Migrations.ReadFile("migrations/0078_send_replay_snapshots.down.sql")
	if err != nil {
		t.Fatalf("read 0073 down: %v", err)
	}
	upSQL, err := deploy.Migrations.ReadFile("migrations/0078_send_replay_snapshots.up.sql")
	if err != nil {
