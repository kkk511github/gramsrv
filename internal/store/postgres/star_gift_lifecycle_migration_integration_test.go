...
// knownMigrationGaps records intentional historical gaps. SafeLink's migration
// series is currently contiguous, including 0123_bot_requested_peer_filters.
var knownMigrationGaps = map[uint]struct{}{}
