...
const (
	stickerSystemKeyMigrationUp   = "migrations/0187_sticker_set_system_key_unique.up.sql"
	stickerSystemKeyMigrationDown = "migrations/0187_sticker_set_system_key_unique.down.sql"
