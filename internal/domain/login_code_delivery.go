...
const officialLoginCodeMessageTemplate = `Login code: %s. Do not give this code to anyone, even if they say they are from %s!
...
func OfficialLoginCodeMessage(userID int64, code string, date int) (Message, error) {
	...
	body := fmt.Sprintf(officialLoginCodeMessageTemplate, code, brand.DefaultAppName, brand.DefaultAppName)
