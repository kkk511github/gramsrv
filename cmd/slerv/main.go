// Command slerv 是基于 iamxvbaba/td 的 SafeLink-compatible server（第一兼容目标：Telegram Desktop）。
package main
...
func run(logger *zap.Logger) error {
	...
	runtimeMetrics := newRuntimeMetricsFanout(metricRegistry, operationalMetrics)
	...
	outboxOptions := []rpc.OutboxOption{
		...
		rpc.WithOutboxMetrics(runtimeMetrics),
	}
	if pushService != nil {
