...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "dashboard.attentionBody": "Operational checks that should be connected to real metrics before triage.",
    ...
    "dashboard.queue.mediaText": "Inspect media storage, conversion and download tasks.",
    "dashboard.queue.dataPending": "Data pending",
    ...
    "dashboard.activityBody": "Current console session and safety events.",
    "dashboard.activity.session": "Management session established",
    "dashboard.activity.sessionText": "Authenticated console session",
    "dashboard.activity.readPath": "Data read path ready",
    "dashboard.activity.readPathText": "PostgreSQL management reads available",
    "dashboard.activity.preview": "Preview policy confirmed",
    "dashboard.activity.previewText": "Dangerous writes require dry-run first",
    "dashboard.activity.runtime": "Runtime overview loaded",
    "dashboard.activity.runtimeText": "Management status surface is ready",
    "dashboard.realtime": "Current session",
    ...
    "dashboard.trend.pendingTitle": "Telemetry not connected",
    "dashboard.trend.pendingText": "Connect the overview metrics endpoint to display real trends.",
  ...
  zh: {
    ...
    "dashboard.attentionBody": "待接入真实指标后进行处置的运维检查项。",
    ...
    "dashboard.queue.mediaText": "检查媒体存储、转码和下载任务。",
    "dashboard.queue.dataPending": "数据待接入",
    ...
    "dashboard.activityBody": "当前控制台会话和安全状态事件。",
    "dashboard.activity.session": "管理会话已建立",
    "dashboard.activity.sessionText": "已验证的控制台会话",
    "dashboard.activity.readPath": "数据读取通道就绪",
    "dashboard.activity.readPathText": "PostgreSQL 管理读取可用",
    "dashboard.activity.preview": "预演策略已确认",
    "dashboard.activity.previewText": "危险写操作需要先预演",
    "dashboard.activity.runtime": "运行总览已加载",
    "dashboard.activity.runtimeText": "管理状态界面已就绪",
    "dashboard.realtime": "当前会话",
    "dashboard.success": "就绪",
    ...
    "dashboard.trend.pendingTitle": "监控数据待接入",
    "dashboard.trend.pendingText": "接入 overview metrics 接口后显示真实趋势。",
