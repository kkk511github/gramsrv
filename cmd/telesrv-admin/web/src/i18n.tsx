...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "route.dashboard": "Runtime Overview",
    ...
    "layout.dashboard": "Runtime Overview",
    "layout.accounts": "Account Management",
    "layout.channels": "Supergroups / Channels",
    "layout.messages": "Message Audit",
	"layout.gifts": "Gift Catalog",
    ...
    "layout.connected": "Management service connected",
    ...
    "layout.lastRefresh": "Updated {time}",
    "language.en": "EN",
    "language.zh": "中文",
    "language.ru": "RU",
    ...
    "dashboard.healthTitle": "Management services are operating normally",
    "dashboard.healthBody": "Core management paths are available and protected by preview-first execution.",
    "dashboard.healthChecking": "Checking management services",
    "dashboard.healthCheckingBody": "Collecting live status from each production dependency.",
    "dashboard.healthDegraded": "Management services need attention",
    "dashboard.healthLiveBody": "Live probes refresh every 15 seconds. Last checked at {time}.",
    "dashboard.healthProbeFailed": "The live status endpoint could not be reached.",
    "dashboard.service.admin": "Admin API",
    "dashboard.service.database": "Data access",
    "dashboard.service.policy": "Execution policy",
    "dashboard.service.audit": "Audit trail",
    "dashboard.service.connected": "Connected",
    "dashboard.service.available": "Available",
    "dashboard.service.protected": "Protected",
    "dashboard.service.retained": "Retained",
    "dashboard.service.traceable": "Traceable actions",
    "dashboard.queueTitle": "Operations workspace",
    "dashboard.queueBody": "Start from the object that needs inspection or action.",
    "dashboard.safetyOn": "Preview protection enabled",
    "dashboard.queue.accountStatus": "Account controls ready",
    "dashboard.queue.messageStatus": "Preview required",
    "dashboard.queue.channelStatus": "Read and manage",
    "dashboard.queue.giftText": "Catalog, revisions, animation assets and collectibles.",
    "dashboard.queue.giftStatus": "Catalog available",
    "dashboard.view": "View",
    "dashboard.guardrailTitle": "Control boundaries",
    "dashboard.guardrailBody": "Built-in safeguards for every administrator.",
    "dashboard.guardrail.dryRunText": "Destructive writes require a successful preview before execution.",
    "dashboard.guardrail.tokenText": "Internal credentials stay on the server side.",
    "dashboard.guardrail.snapshotText": "Raw state and command results remain available for audit.",
    "dashboard.workflowTitle": "Standard workflow",
    "dashboard.workflowBody": "A consistent path for account, channel and message operations.",
    "dashboard.workflow.find": "Find the object",
    "dashboard.workflow.findText": "Search by ID, phone, username or title, then inspect the current state.",
    "dashboard.workflow.preview": "Run preview",
    "dashboard.workflow.previewText": "Validate scope, parameters and the expected impact without applying changes.",
    "dashboard.workflow.execute": "Confirm execution",
    "dashboard.workflow.executeText": "Apply only after review and retain the command result in the audit trail.",
    "dashboard.safetyTitle": "Preview-first protection is enabled for dangerous operations",
    "dashboard.safetyBody": "Freeze, revoke, delete and catalog changes remain reviewable before execution.",
    "dashboard.openWorkspace": "Open account workspace",
    "dashboard.service.push": "Push service",
    "dashboard.service.media": "Media storage",
    "dashboard.service.checking": "Checking",
    "dashboard.service.unavailable": "Unavailable",
    "dashboard.service.collecting": "Collecting live metrics",
    "dashboard.service.probeFailed": "Live probe failed",
    "dashboard.service.state.healthy": "Healthy",
    "dashboard.service.state.degraded": "Degraded",
    "dashboard.service.state.unavailable": "Unavailable",
    "dashboard.service.state.disabled": "Disabled",
    "dashboard.service.endpointDetail": "{endpoint} · {latency}",
    "dashboard.service.postgresDetail": "Pool {acquired}/{total} · {latency}",
    "dashboard.service.pushDetail": "{providers} · {devices} devices · {pending} queued · {retrying} retrying",
    "dashboard.service.pushDisabled": "Push delivery is disabled by configuration",
    "dashboard.service.mediaDetail": "{backend} · {objects} objects · {size}",
    "dashboard.attentionTitle": "Needs attention",
    "dashboard.attentionBody": "Live checks from account, delivery, and media records.",
    "dashboard.viewAll": "View all work",
    "dashboard.table.item": "Item",
    "dashboard.table.severity": "Severity",
    "dashboard.table.count": "Count",
    "dashboard.table.statusOwner": "Status / Owner",
    "dashboard.table.discovered": "Discovered",
    "dashboard.severity.high": "High",
    "dashboard.severity.medium": "Medium",
    "dashboard.severity.normal": "Normal",
    "dashboard.queue.freezeTitle": "Frozen-account review",
    "dashboard.queue.freezeText": "Review account freezes and confirm restored states.",
    "dashboard.queue.pushTitle": "Push delivery check",
    "dashboard.queue.pushText": "Inspect delivery paths, retries and device reachability.",
    "dashboard.queue.mediaTitle": "Media task check",
    "dashboard.queue.mediaText": "Incomplete uploads older than the configured retention window.",
    "dashboard.queue.state.healthy": "Normal",
    "dashboard.queue.state.needs_review": "Review required",
    "dashboard.queue.state.retrying": "Retrying",
    "dashboard.queue.state.overdue": "Overdue",
    "dashboard.queue.none": "None",
    "dashboard.queue.riskOwner": "Risk operations",
    "dashboard.queue.messageOwner": "Messaging operations",
    "dashboard.queue.mediaOwner": "Media operations",
    "dashboard.activityTitle": "Administrator activity",
    "dashboard.activityBody": "Latest persisted administrator audit records.",
    "dashboard.activity.audit": "Audit log",
    "dashboard.activity.empty": "No administrator operations have been recorded.",
    "dashboard.activity.dryRunTitle": "Preview: {action}",
    "dashboard.activity.detail": "{actor} · {target}",
    "dashboard.activity.targetUser": "User #{id}",
    "dashboard.activity.targetPeer": "{type} #{id}",
    "dashboard.activity.targetSystem": "System scope",
    "dashboard.activity.status.running": "Running",
    "dashboard.activity.status.completed": "Completed",
    "dashboard.activity.status.failed": "Failed",
    "dashboard.activity.action.setFrozen": "Updated account freeze",
    "dashboard.activity.action.grantPremium": "Updated Premium access",
    "dashboard.activity.action.grantStars": "Granted Stars",
    "dashboard.activity.action.setVerified": "Updated account verification",
    "dashboard.activity.action.setChannelVerified": "Updated channel verification",
    "dashboard.activity.action.revokeSessions": "Revoked sessions",
    "dashboard.activity.action.deleteMessages": "Deleted messages",
    "dashboard.activity.action.deleteHistory": "Deleted message history",
    "dashboard.activity.action.importGift": "Imported gift",
    "dashboard.activity.action.importOfficialGift": "Imported official gift",
    "dashboard.activity.action.publishCollectibles": "Published gift collectibles",
    "dashboard.activity.action.setGiftEnabled": "Updated gift availability",
    "dashboard.activity.action.setGiftOrder": "Updated gift order",
    "dashboard.trendTitle": "Runtime trends",
    "dashboard.trendBody": "Live operational telemetry",
    "dashboard.last24Hours": "Last 24 hours",
    "dashboard.trend.messages": "Messages / min",
    "dashboard.trend.api": "API requests / min",
    "dashboard.trend.push": "Push success",
    "dashboard.trend.loadingText": "Reading message, RPC, and push telemetry.",
    "dashboard.trend.failedText": "The operational metrics endpoint could not be reached.",
    "dashboard.trend.chartLabel": "Message rate, API request rate, and push success over the last 24 hours",
    "dashboard.trend.pushAttempts": "Push attempts",
    "dashboard.trend.privacy": "Minute aggregates only. No message content, user identity, or device token is recorded.",
    "dashboard.data.loading": "Loading live operational data",
    "dashboard.data.failed": "Operational data unavailable",
	...
	"giveGift.senderHint": "Gifts are always sent from the system account 777000 (SafeLink).",
	...
	"giveGifts.hint": "Pick a gift to grant. Delivery is free of charge and sent from the system account 777000 (SafeLink) by default.",
  ...
  zh: {
    ...
    "layout.dashboard": "运行总览",
    "layout.accounts": "账号管理",
    "layout.channels": "超级群/频道",
    "layout.messages": "消息审计",
    ...
    "dashboard.healthTitle": "管理服务运行正常",
    "dashboard.healthBody": "核心管理路径可用，危险操作已启用预演保护。",
    "dashboard.healthChecking": "正在检测管理服务",
    "dashboard.healthCheckingBody": "正在采集各项生产依赖的实时状态。",
    "dashboard.healthDegraded": "管理服务存在异常",
    "dashboard.healthLiveBody": "实时探测每 15 秒刷新，上次检查于 {time}。",
    "dashboard.healthProbeFailed": "无法连接实时状态接口。",
    "dashboard.service.admin": "管理接口",
    "dashboard.service.database": "数据读取",
    "dashboard.service.policy": "执行策略",
    "dashboard.service.audit": "审计记录",
    "dashboard.service.connected": "已连接",
    "dashboard.service.available": "可用",
    "dashboard.service.protected": "已保护",
    "dashboard.service.retained": "已保留",
    "dashboard.service.traceable": "操作可追溯",
    "dashboard.queueTitle": "运维工作区",
    "dashboard.queueBody": "从需要查询或处置的对象开始。",
    "dashboard.safetyOn": "预演保护已开启",
    "dashboard.queue.accountStatus": "账号操作可用",
    "dashboard.queue.messageStatus": "操作需要预演",
    "dashboard.queue.channelStatus": "支持查询与管理",
    "dashboard.queue.giftText": "目录、修订版本、动画资源与收藏属性。",
    "dashboard.queue.giftStatus": "目录可用",
    "dashboard.view": "查看",
    "dashboard.guardrailTitle": "控制边界",
    "dashboard.guardrailBody": "面向所有管理员的内置安全约束。",
    "dashboard.guardrail.dryRunText": "破坏性写操作必须先完成预演，再允许执行。",
    "dashboard.guardrail.tokenText": "内部凭据始终保留在服务端。",
    "dashboard.guardrail.snapshotText": "原始状态和命令结果会保留用于审计。",
    "dashboard.workflowTitle": "标准工作流",
    "dashboard.workflowBody": "账号、频道和消息操作使用一致的处置步骤。",
    "dashboard.workflow.find": "查找对象",
    "dashboard.workflow.findText": "按 ID、手机号、用户名或标题查询并核对当前状态。",
    "dashboard.workflow.preview": "执行预演",
    "dashboard.workflow.previewText": "在不写入的情况下检查范围、参数和预期影响。",
    "dashboard.workflow.execute": "确认执行",
    "dashboard.workflow.executeText": "复核后再应用变更，并将命令结果保留在审计记录中。",
    "dashboard.safetyTitle": "危险操作已开启先预演保护",
    "dashboard.safetyBody": "冻结、注销会话、删除和目录变更均可在执行前复核。",
    "dashboard.openWorkspace": "进入账号工作区",
    "dashboard.service.push": "推送服务",
    "dashboard.service.media": "媒体存储",
    "dashboard.service.checking": "检测中",
    "dashboard.service.unavailable": "不可用",
    "dashboard.service.collecting": "正在采集实时指标",
    "dashboard.service.probeFailed": "实时探测失败",
    "dashboard.service.state.healthy": "运行正常",
    "dashboard.service.state.degraded": "部分异常",
    "dashboard.service.state.unavailable": "不可用",
    "dashboard.service.state.disabled": "未启用",
    "dashboard.service.endpointDetail": "{endpoint} · {latency}",
    "dashboard.service.postgresDetail": "连接池 {acquired}/{total} · {latency}",
    "dashboard.service.pushDetail": "{providers} · {devices} 台设备 · 队列 {pending} · 重试 {retrying}",
    "dashboard.service.pushDisabled": "生产配置未启用推送投递",
    "dashboard.service.mediaDetail": "{backend} · {objects} 个对象 · {size}",
    "dashboard.attentionTitle": "需要关注",
    "dashboard.attentionBody": "来自账号、投递队列和媒体记录的实时检查结果。",
    "dashboard.viewAll": "查看全部工单",
    "dashboard.table.item": "事项",
    "dashboard.table.severity": "严重性",
    "dashboard.table.count": "数量",
    "dashboard.table.statusOwner": "状态 / 负责人",
    "dashboard.table.discovered": "发现时间",
    "dashboard.severity.high": "高",
    "dashboard.severity.medium": "中",
    "dashboard.severity.normal": "正常",
    "dashboard.queue.freezeTitle": "冻结账号复核",
    "dashboard.queue.freezeText": "复核账号冻结和解冻后的状态。",
    "dashboard.queue.pushTitle": "推送投递检查",
    "dashboard.queue.pushText": "检查投递通道、重试和设备可达性。",
    "dashboard.queue.mediaTitle": "媒体任务检查",
    "dashboard.queue.mediaText": "超过配置保留时间仍未完成的上传任务。",
    "dashboard.queue.state.healthy": "正常",
    "dashboard.queue.state.needs_review": "需要复核",
    "dashboard.queue.state.retrying": "正在重试",
    "dashboard.queue.state.overdue": "已超时",
    "dashboard.queue.none": "无",
    "dashboard.queue.riskOwner": "风险组",
    "dashboard.queue.messageOwner": "消息组",
    "dashboard.queue.mediaOwner": "媒体组",
    "dashboard.activityTitle": "管理员操作动态",
    "dashboard.activityBody": "最近写入审计日志的真实管理员操作。",
    "dashboard.activity.audit": "审计日志",
    "dashboard.activity.empty": "暂无管理员操作记录。",
    "dashboard.activity.dryRunTitle": "预演：{action}",
    "dashboard.activity.detail": "{actor} · {target}",
    "dashboard.activity.targetUser": "用户 #{id}",
    "dashboard.activity.targetPeer": "{type} #{id}",
    "dashboard.activity.targetSystem": "系统范围",
    "dashboard.activity.status.running": "执行中",
    "dashboard.activity.status.completed": "已完成",
    "dashboard.activity.status.failed": "失败",
    "dashboard.activity.action.setFrozen": "更新账号冻结状态",
    "dashboard.activity.action.grantPremium": "更新高级版权限",
    "dashboard.activity.action.grantStars": "发放 Stars",
    "dashboard.activity.action.setVerified": "更新账号认证",
    "dashboard.activity.action.setChannelVerified": "更新频道认证",
    "dashboard.activity.action.revokeSessions": "注销设备会话",
    "dashboard.activity.action.deleteMessages": "删除消息",
    "dashboard.activity.action.deleteHistory": "删除消息历史",
    "dashboard.activity.action.importGift": "导入礼物",
    "dashboard.activity.action.importOfficialGift": "导入官方礼物",
    "dashboard.activity.action.publishCollectibles": "发布礼物收藏属性",
    "dashboard.activity.action.setGiftEnabled": "更新礼物上架状态",
    "dashboard.activity.action.setGiftOrder": "更新礼物排序",
    "dashboard.trendTitle": "运行趋势",
    "dashboard.trendBody": "线上运维监控指标",
    "dashboard.last24Hours": "过去 24 小时",
    "dashboard.trend.messages": "消息/分钟",
    "dashboard.trend.api": "API 请求/分钟",
    "dashboard.trend.push": "推送成功率",
    "dashboard.trend.loadingText": "正在读取消息、RPC 和推送遥测数据。",
    "dashboard.trend.failedText": "无法连接运行指标接口。",
    "dashboard.trend.chartLabel": "过去 24 小时的消息速率、API 请求速率和推送成功率",
    "dashboard.trend.pushAttempts": "推送尝试次数",
    "dashboard.trend.privacy": "仅保存分钟级汇总，不记录消息内容、用户身份或设备令牌。",
    "dashboard.data.loading": "正在读取真实运行数据",
    "dashboard.data.failed": "运行数据暂不可用",
	...
	"giveGift.senderHint": "礼物始终由系统账号 777000（SafeLink）发送。",
	...
	"giveGifts.hint": "选择要发放的礼物。发放免费，默认由系统账号 777000（SafeLink）发送。",
  ...
  "giveGift.senderHint": "Подарки всегда отправляются от системного аккаунта 777000 (SafeLink).",
  ...
  "giveGifts.hint": "Выберите подарок для выдачи. Выдача бесплатна и по умолчанию отправляется от системного аккаунта 777000 (SafeLink).",
