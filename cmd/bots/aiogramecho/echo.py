#!/usr/bin/env python3
"""aiogram 3 echo/button demo for the SafeLink Bot API endpoint."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="aiogram 3 echo bot against SafeLink")
...
def build_dispatcher(args: argparse.Namespace) -> Dispatcher:
    ...
    async def callback(query: CallbackQuery) -> None:
        await query.answer(f"SafeLink {query.data} callback OK")
    ...
    async def fallback_callback(query: CallbackQuery) -> None:
        ...
        await query.answer("SafeLink callback OK")
