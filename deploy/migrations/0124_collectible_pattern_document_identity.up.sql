-- Telegram clients cache Document metadata by id indefinitely. Migration 0121
...
-- Allocate a new immutable document identity for every pre-0124 pattern, keep a
